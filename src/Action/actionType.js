...
//getproductsBySlug
export const GET_PRODUCTS_BY_SORT_REQUEST = "GET_PRODUCTS_BY_SORT_REQUEST";
export const GET_PRODUCTS_BY_SORT_CREATEDAT_SUCCESS =
  "GET_PRODUCTS_BY_SORT_CREATEDAT_SUCCESS";
export const GET_PRODUCTS_BY_SORT_SOLD_SUCCESS =
  "GET_PRODUCTS_BY_SORT_SOLD_SUCCESS";
export const GET_PRODUCTS_BY_SORT_FAILURE = "GET_PRODUCTS_BY_SORT_FAILURE";
//getDiscount
